...
assessmentButton.addEventListener(
  ...
  () => {
    ...
    const hrefValue = 'https://twitter.com/intent/tweet?button_hashtag=' + encodeURKComponent('あなたのいいところ') + '&ref_src=twsrc%5Etfw';

    anchor.setAttribute('href', hrefValue);
    anchor.setAttribute('class','twitter-hasyutag-button');
    anchor.setAttribute('data-text', result);
    anchor.innerText = 'Tweet #あなたのいいところ';

    tweetDivision.appendChild(anchor);

    const script = document.createElement('script');//scriptタグ制作
